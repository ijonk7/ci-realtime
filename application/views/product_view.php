...
<br>
<button type="button" class="btn btn-primary mb-3" data-toggle="modal" data-target="#ModalAdd">Tambah Produk</button>
...
<footer class="w3-container w3-black w3-center w3-margin-top">
  <p style="margin-top: 10px">Find me on <a href="https://github.com/ijonk7" target="_blank" style="text-decoration: none;">Github 
...
<input type="text" name="product_name" class="form-control name" id="input1" placeholder="Nama Produk">
</div>
<div class="form-group">
<label for="input2">Harga</label>
<input type="text" name="product_price" class="form-control price" id="input2" placeholder="Harga">
</div>
</div>
...
<div class="form-group">
<label for="input1">Nama Produk</label>
<input type="text" name="product_name" class="form-control name_edit" id="input1" placeholder="Nama Produk">
</div>
<div class="form-group">
<label for="input2">Harga</label>
<input type="text" name="product_price" class="form-control price_edit" id="input2" placeholder="Harga">
</div>
</div>
<div class="modal-footer">
<input type="hidden" name="product_id" class="id_edit">
<button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
<button type="submit" class="btn btn-primary btn-edit">Simpan</button>
</div>
</div>
</div>
</div>
        ...
        $.ajax({
            ...
            success : function(data){
                ...
                for(i=0; i<data.length; i++){
                    ...
                    '<td>'+
                    '<a href="javascript:void(0);" class="btn btn-sm btn-info item_edit" data-id="'+ data[i].product_id +'" data-name="'+ data[i].product_name +'" data-price="'+ data[i].product_price +'">Ubah</a>&nbsp;'+
                    '<a href="javascript:void(0);" class="btn btn-sm btn-danger item_delete" data-id="'+ data[i].product_id +'">Hapus</a>'+
                    '</td>'+
                    '</tr>';
                }
